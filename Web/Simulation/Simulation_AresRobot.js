...
export class AresRobotSubsystem {
  constructor(ctx) {
    this.ctx = ctx;
    this.eyeL = null;
    this.eyeR = null;
    ...
    this.eyeGlowTex = EYE ? makeGlowTex(EYE_PALETTE.glowStops) : null;
    this.chestGlowTex = CHEST ? makeGlowTex(CHEST_PALETTE.glowStops) : null;

    if (EYE) {
      this.eyeL = makeLed(EYE.radius, EYE.left, EYE_PALETTE, this.eyeGlowTex);
      this.eyeR = makeLed(EYE.radius, EYE.right, EYE_PALETTE, this.eyeGlowTex);
    }
    if (CHEST) {
      this.chestLed = makeLed(CHEST.radius, CHEST.pos, CHEST_PALETTE, this.chestGlowTex);
    }
  }
  ...
  get hasEyes() { return !!this.ctx.cfg.eyes; }
  get hasChest() { return !!this.ctx.cfg.chest; }
}
