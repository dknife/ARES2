...
\fancyfoot[L]{\sffamily\small\color{deepblue}\bfseries ARES BLE 파이프라인 · 부팅 안정화 · DC 모터 · HTTPS · BATCH}
...
\title{%
  ...
  {\rmfamily\normalsize\color{accentcopper}BLE 명령 파이프라인 최적화 · 부팅 안정화 · DC 모터 대칭 출력 · HTTPS 사용 사유 · BATCH 명령 블록}\\[2pt]
