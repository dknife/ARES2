...
%% ============================================================
\section{2차 Refactoring 계획 (전문)}
\label{app:refactor2}

\textit{작성일 2026-06-26 --- 1차 계획(부록~\ref{app:refactor1})의 연장선.}
...
\subsection{트랙 1 --- 시뮬레이터 (\code{Web/simulation.js}, \code{Web/Mesh/})}

\subsubsection{1.1 요소별 코드 분할}
...
\subsubsection{1.2 단위 메쉬 로딩 후 Transform 조작}
...
\subsection{트랙 2 --- 피코 + 블록코딩 (\code{Pico/}, \code{blocklyconfig.js}, \code{Missions/})}

\subsubsection{2.1 요소 피코 코드 점검}
...
\subsubsection{2.2 미션별 블록 노출 시스템 개선}
...
\subsubsection{2.3 미션 주제별 필요 블록 설계}
...
\subsection{트랙 3 --- 웹 인터페이스 (\code{Web/*.html}, \code{index.css}, \code{mobile-preview.js})}
\begin{itemize}
