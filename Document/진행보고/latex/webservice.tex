%% ============================================================
%% webservice.tex — 배포된 웹 서비스 주요 기능 (라이브 캡처)
%% 출처: https://dknife.github.io/ARES2 (2026-06-27 캡처)
%% ============================================================
\section{배포된 웹 서비스 주요 기능}
GitHub Pages로 배포된 ARES 웹 서비스(\href{https://dknife.github.io/ARES2}{\code{dknife.github.io/ARES2}})를
직접 구동하며 주요 기능을 점검하고 캡처했다. 설치 없이 브라우저만으로 학습 콘텐츠
열람, 블록 코딩, 3D 시뮬레이션, AI 도움, 기기 모니터링이 가능하다. 블록 1개가
명령 문자열로 변환되어 BLE로 로버에 전달되는 전체 경로(부록~\ref{app:code})를
실물 기기 없이도 시뮬레이션으로 체험할 수 있다.
...
\begin{figure}[H]\centering
  \begin{subfigure}{0.49\linewidth}\centering
    \fbox{\includegraphics[width=\linewidth]{webcaps/web_landing.png}}
    \caption{랜딩 페이지 — 제품 소개 히어로}
  \end{subfigure}\hfill
  \begin{subfigure}{0.49\linewidth}\centering
    \fbox{\includegraphics[width=\linewidth]{webcaps/web_overview.png}}
...
\begin{figure}[H]\centering
  \begin{subfigure}{0.49\linewidth}\centering
    \fbox{\includegraphics[width=\linewidth]{webcaps/web_blockcoding.png}}
    \caption{블록 코딩 — ‘장애물 피하기’ 예제(센서$\cdot$DC$\cdot$LED$\cdot$부저)}
  \end{subfigure}\hfill
  \begin{subfigure}{0.49\linewidth}\centering
    \fbox{\includegraphics[width=\linewidth]{webcaps/web_simulation.png}}
...
\begin{figure}[H]\centering
  \begin{subfigure}{0.49\linewidth}\centering
    \fbox{\includegraphics[width=\linewidth]{webcaps/sim_albi.png}}
    \caption{알비와 함께 — 로봇$\cdot$LED}
  \end{subfigure}\hfill
  \begin{subfigure}{0.49\linewidth}\centering
    \fbox{\includegraphics[width=\linewidth]{webcaps/sim_traffic.png}}
    \caption{우주 신호등 — 신호등$\cdot$가위바위보}
  \end{subfigure}

  \medskip
  \begin{subfigure}{0.49\linewidth}\centering
    \fbox{\includegraphics[width=\linewidth]{webcaps/sim_launchpad.png}}
    \caption{발사대 — 로켓 발사 시퀀스}
  \end{subfigure}\hfill
  \begin{subfigure}{0.49\linewidth}\centering
    \fbox{\includegraphics[width=\linewidth]{webcaps/sim_rover.png}}
...
\begin{figure}[H]\centering
  \begin{subfigure}{0.49\linewidth}\centering
    \fbox{\includegraphics[width=\linewidth]{webcaps/web_ai.png}}
    \caption{AI 도움 — 자연어로 블록 구성 제안}
  \end{subfigure}\hfill
  \begin{subfigure}{0.49\linewidth}\centering
    \fbox{\includegraphics[width=\linewidth]{webcaps/web_dashboard.png}}
