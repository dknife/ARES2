...
\bottomrule
\end{tabularx}
\caption{2026-05-19 \textendash{} 05-28 변경 범위 (롤링).}
\end{table}
...
05-28 & \textit{(pending)} & Inline all simulation GLBs into vendor/inline\_assets.js, drop Build/Mesh/ and move ares\_robot.embed.js to Build/ root, refresh FinalBuild.md tree \\
\bottomrule
\end{tabularx}
\caption{관련 커밋 (\texttt{main} 브랜치). 05-22 / 05-28 행은 본 문서 갱신 시점에 아직 커밋되지 않은 작업.}
\end{table}
